...
const TypingArea = () => {
  ...
  const wordsPunctuationNumberList = [
    ...
    "The moment I stepped onto the pavement for my morning run, the city was still wrapped in a soft, golden haze. It was 6:30 AM just early enough that the streets whispered rather than roared. With each stride, my sneakers tapped a steady rhythm against the asphalt, syncing with my breath, syncing with my thoughts. This wasnt just exercise it was a ritual, a way to clear mental clutter and inject clarity before the noise of the day set in. I took the familiar turn near the park, where sunlight filtered through tall trees like a spotlight on the path ahead. For 30 minutes, I wasnt worried about deadlines or expectations. I was just present. By the time I looped back to my front gate, lungs full, mind sharp, I felt grounded. That run didnt just start my day it reset me. It reminded me that showing up for myself, even in small, sweaty ways, pays off in focus, energy, and grit.",
    ...
    "By 1130 I was back at my desk trying to review the 5 key points from todays lecture but only remembered 2 One of them was about time complexity and the other was just a random meme the prof accidentally showed in class I set 3 alarms for the morning and told myself tomorrow Id wake up early and be productive Lets see how that goes made our first stop after 2 hours to stretch our legs and grab some coffee. By 3:00 PM, we had already covered 150 kilometers and were halfway through our journey. The scenery was breathtaking, with mountains on one side and forests on the other. After 6 hours of driving, we--- ith the multiple-choice section, finishing it in 30 minutes. By 10:30 AM, I had completed all the short-answer questions and moved on to the essays. I spent the remaining time carefully crafting my responses, ensuring I answered everything thoroughly. At 11:55 AM, I submitted my paper, feeling confident that I had done my best and was ready to relax after such an intense test-"
